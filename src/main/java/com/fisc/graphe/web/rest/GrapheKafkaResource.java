...
@RestController
@RequestMapping("/api/graphe-kafka")
public class GrapheKafkaResource {

    private final Logger log = LoggerFactory.getLogger(GrapheKafkaResource.class);

    private final KafkaProperties kafkaProperties;
    private KafkaProducer<String, String> producer;
    private ExecutorService sseExecutorService = Executors.newCachedThreadPool();

    public GrapheKafkaResource(KafkaProperties kafkaProperties) {
